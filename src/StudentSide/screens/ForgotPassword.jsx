import { View, Text, Image, StyleSheet, Dimensions, Alert, ScrollView, TextInput, SafeAreaView, Pressable, Modal, TouchableOpacity, KeyboardAvoidingView, Platform } from 'react-native'
      ...
      fetch(url)
        ...
        .then(data => {
          ...
          if (data == '4') {
            ...
            submitModel(ALERT_TYPE.INFO, "Already Sent", `E-mail is already sent please try after 15 minutes from successful request`)
          }
          else {
                ...
                visible={showModal2}> 
                    ...
                    <View style={styles.modalView}>
                       <FontAwesome name='exclamation-circle' size={64} color={colors.uniRed} style={{position:'absolute', top:-48, backgroundColor:'white', padding:16, borderRadius:100}} />
                        ...
                        <Text style={styles.textSmall}>Enter IDNo/ClassRollNo/UniRollNo and Email ID !!!'</Text>
              ...
              <View style={styles.inputView}>
                <View style={styles.loginInput}>
                  ...
                  <TextInput
                    ...
                    placeholder='IDNo/ClassRollNo/UniRollNo'
