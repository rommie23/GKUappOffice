...
const PlusIcon = () => {
    ...
    // };
    const ApplyLeaveFormFunction = () => {
        // Alert.alert('gg')
        isOpen.value = true
        navigation.navigate('ApplyLeaveForm')

    }
    const MovmentRegisterFunction = () => {
        navigation.navigate('MovementRequest')
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity onPressIn={() => ApplyLeaveFormFunction()} >
            ...
            <TouchableOpacity onPressIn={() => MovmentRegisterFunction()}>
                <Animated.View
