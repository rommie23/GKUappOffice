...
const SupervisorLeavesRejected = () => {
  ...
  const getPendingLeaves = async () => {
    ...
    setIsLoading(true);
    try {
      const PendingDetails = await fetch(BASE_URL + '/Staff/supervisorRejectedLeaves?page=' + page, {
        method: 'POST',
        headers: {
                ...
                <View style={styles.card}>
                  <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <View style={[styles.bottomCardTop, { flex: 3 }]}>
                      <FontAwesome5Icon
                        name={
                          item['Status'] == "Reject" ? "clock"
                            : null

                        } size={24} color={item['Status'] == 'Reject' ? colors.uniRed
                          : colors.uniBlue} />
                      <Text style={[styles.textStyle, {
                        fontWeight: '600', color: item['Status'] == 'Reject' ? colors.uniRed
                          : colors.uniBlue
                      }]}>
...
export default SupervisorLeavesRejected;
