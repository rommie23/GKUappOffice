...
const StudentLeaveRequests = () => {
  ...
  const hostelLeaves = async () => {
    ...
    if (session != null) {
      try {
        const res = await axios.get(`${BASE_URL}/staff/allLeaves`,
          {
            headers: {
  ...
  const handleButtons = async (action, ID) => {
    ...
    if (session != null) {
      try {
        const res = await axios.post(`${BASE_URL}/staff/leaveAction`, {
          action: action,
          leaveId: ID
        },
          {
  ...
  const searchStudent = async () => {
    ...
    if (session != null) {
      try {
        const res = await axios.post(`${BASE_URL}/staff/leaveSearchStudentHostel`,
          {
            rollNo: rollNo
          },
          {
        ...
        console.log("searchStudent::::::", res.data.allLeaves);
