...
const SupervisorCompletedTask = () => {
  ...
  const assignedTasks = async () => {
    setLoading(true)
    try {
      const response = await axios.post(`${LIMS_URL}/complain/completedTasks`, { StaffIDNo })
      const completedTasksData = response.data;
      setComplainData(completedTasksData)
                ...
                <View style={styles.card} key={i}>
                  ...
                  <View style={styles.transaction}>
                    ...
                    <View style={{ width: '30%' }}>
                      ...
                      <TouchableOpacity onPress={() => navigation.navigate('OpenImage', { imageURI: `tms/uploads/${item['work_image']}` })}>
