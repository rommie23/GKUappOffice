                ...
                <View style={styles.cardOuter}>
                  <ScrollView horizontal style={{ width: screenWidth > screenHeight && "100%" }}>
                    <View style={{ flex: 1 }}>
                      ...
                      {/* 🔹 TABLE HEADER */}
                      <View style={{ flexDirection: 'row', width: screenWidth * 2, backgroundColor: colors.uniBlue, marginTop:20 }}>
                        <View style={[styles.cellStyle, { flex: 0.15 }]}>
                          <Text style={[styles.cardTxt, { color: 'white' }]}>Sno.</Text>
                        </View>
                        <View style={[styles.cellStyle, { flex: 2.5 }]}>
                        ...
                        <View style={[styles.cellStyle, { flex: 0.75 }]}>
