...
const ExamFormAgricultureDiploma = () => {
    ...
    const getExamFormData = async () => {
        ...
        if (session != null) {
            try {
                const examForm = await fetch(BASE_URL + '/student/examdate/3', {
                    method: 'POST',
                    headers: {
                ...
                console.log('data froms api examForm diplomaAgri regular:::', examFormDetails['statusopen'][0])
                setLoading(false)
                // console.log(transactions);
            } catch (error) {
                console.log('Error fetching form diplomaAgri data:examFrom phd regular:', error)
                setLoading(false)
                errorModel(ALERT_TYPE.WARNING, "Oops!!!", `Something went wrong !!`)
                // setShowModal2(true)
            }
    ...
    const getSubjects = async () => {
        ...
        if (session != null) {
            try {
                ...
                // console.log('data froms api examForm Subjects diplomaAgri regular:::',examSemesterDetails['data'])
                setLoading(false)
            } catch (error) {
                console.log('Error fetching diplomaAgri form data:examFrom regular:', error)
                setLoading(false)
                errorModel(ALERT_TYPE.WARNING, "Oops!!!", `Something went wrong !!`)
                // setShowModal2(true)
            }
...
export default ExamFormAgricultureDiploma
